...
/***/ function(module, exports, __webpack_require__) {
	...
	window.MyApp = {
	    init: function init(data) {
	        ReactDOM.render(React.createElement(_landingpage2.default, { profile_info: data }), document.getElementById("landing-page"));
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sidebarele = __webpack_require__(167);

	var _sidebarele2 = _interopRequireDefault(_sidebarele);
	...
	var LandingPage = function (_React$Component) {
	    ...
	    function LandingPage(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LandingPage).call(this, props)); /* Note props is passed into the constructor in order to be used */


	        _this.state = { curUser: props.profile_info.data,
	            curElement: 0,
	            sideBarContents: props.profile_info.data.level === "TRAINER" ? ["My Profile", "My Trainees", "Calendar", "Saved Workouts", "Trainee Nearby", "Settings"] : ["My Profile", "Calendar", "Saved Workouts", "Settings"] };
	    ...
	    _createClass(LandingPage, [{
	        key: 'onSideBarClick',
	        value: function onSideBarClick(index) {
	        ...
	        value: function render() {
	            ...
	            var sideBarEle = this.state.sideBarContents.map(function (ele, i) {
	                ...
	                return React.createElement(_sidebarele2.default, { text: ele, onClick: boundClick, curElement: this.state.curElement, key: i, eleIndex: i });
	            }, this);
	            var contentDisplay = React.createElement(_content2.default, { curContent: this.state.sideBarContents[this.state.curElement], curUser: this.state.curUser });
	            return React.createElement(
	                'div',
	                null,
	                React.createElement(
	                    'div',
	                    { className: 'side-bar-parent' },
	                    sideBarEle
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'content-panel-parent' },
	                    contentDisplay
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mytrainees = __webpack_require__(163);

	var _mytrainees2 = _interopRequireDefault(_mytrainees);

	var _workouts = __webpack_require__(164);

	var _workouts2 = _interopRequireDefault(_workouts);

	var _finder = __webpack_require__(165);
	    ...
	    _createClass(Content, [{
	        ...
	        value: function render() {
	            ...
	            if (this.props.curContent === "My Profile") {
	                ...
	                display = React.createElement(_mytrainees2.default, null);
	                ...
	                display = React.createElement(_workouts2.default, null);
	            } else if (this.props.curContent == "Trainee Nearby") {
	                display = React.createElement(_finder2.default, null);
	            } else {
	                display = React.createElement(_settings2.default, null);
	            }
	            return React.createElement(
	                'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CurrentTrainees = function (_React$Component) {
	    _inherits(CurrentTrainees, _React$Component);

	    function CurrentTrainees(props) {
	        _classCallCheck(this, CurrentTrainees);

	        /* Note props is passed into the constructor in order to be used */
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(CurrentTrainees).call(this, props));
	    }

	    _createClass(CurrentTrainees, [{
	        key: 'render',
	        value: function render() {
	            return React.createElement(
	                'h1',
	...
	exports.default = CurrentTrainees;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Workouts = function (_React$Component) {
	    ...
	    function Workouts(props) {
	        ...
	        /* Note props is passed into the constructor in order to be used */
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Workouts).call(this, props));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Finder = function (_React$Component) {
	    ...
	    function Finder(props) {
	        ...
	        /* Note props is passed into the constructor in order to be used */
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Finder).call(this, props));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideBarEle = function (_React$Component) {
	    _inherits(SideBarEle, _React$Component);

	    function SideBarEle(props) {
	        _classCallCheck(this, SideBarEle);

	        /* Note props is passed into the constructor in order to be used */
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(SideBarEle).call(this, props));
	    }

	    _createClass(SideBarEle, [{
	        key: 'render',
	        value: function render() {
	            var eleClass = "";
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { className: eleClass, onClick: this.props.onClick },
	                    this.props.text
	                )
	            );
	        }
